...
public class SpellCheck {
    ...
    private HashMap<Strin, ArrayList<String>> trigrams;
    private HashMap<String, Integer> final_words;
    ...
    public SpellCheck(Map<String, BigInteger> dictionary, HashMap<String, ArrayList<String>> trigrams, String wrong_word){
    ...
    public HashMap<String, Integer> solve(){
        //Solve method for this spell check
    }
